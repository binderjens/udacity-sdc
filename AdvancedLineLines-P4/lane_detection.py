...
def generate_polyline_windowed(binary_warped, name=''):
    ...
    if name!='':
        ...
        [left_fitx, right_fitx, ploty] = generate_fitting(binary_warped.shape[0],left_fit,right_fit)
...
def generate_polyline(binary_warped, left_fit, right_fit, left_polylines, right_polylines, name='' ):
    ...
    if name!='':
        [left_fit_x, right_fitx, ploty] = generate_fitting(binary_warped.shape[0],left_fit,right_fit)
