...
def generate_polyfit_from_indices(binary_warped,left_lane_inds, right_lane_inds):
...
def generate_polyline_windowed(binary_warped, name=''):
    ...
    if name!='':
        # Create an output image to draw on and  visualize the result when we have an output name
    ...
    for window in range(nwindows):
        ...
        # in case we have a save file name - draw on img
        if name!='':
...
def generate_polyline(binary_warped, left_lane, right_lane, name='' ):
    ...
    [left_fit, right_fit] = generate_polyfit_from_indices(binary_warped, left_lane_inds, right_lane_inds)
